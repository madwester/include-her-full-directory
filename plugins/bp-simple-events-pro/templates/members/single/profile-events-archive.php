...
<?php if ( $wp_query->have_posts() ) : ?>
	...
	<?php while ( $wp_query->have_posts() ) : $wp_query->the_post(); 	?>
		...
		<div class="entry-content eventItemList pastEvent">
...
<?php else : ?>
	...
	<div class="entry-content"><br/><?php __( 'There are no expired Events created by this member.', 'bp-simple-events' ); ?></div>
