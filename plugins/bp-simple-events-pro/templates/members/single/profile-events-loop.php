...
<br>
			...
			if( ! empty( $meta['event-address'][0] ) )
				echo '<br/>' . __( '', 'bp-simple-events' ) . '' . $meta['event-address'][0];
...
<?php else : ?>
	...
	<div class="entry-content"><br/><?php __( 'There are no upcoming Events created by this member. There may be Events in the Archive.', 'bp-simple-events' ); ?></div>
